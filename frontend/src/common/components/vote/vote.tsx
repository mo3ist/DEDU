	...
	return (
		...
		>
			...
			<ProtectedButton
				...
				className={classname("text-primary border-2 border-primary rounded-lg md:w-10", {"rounded-lg bg-primary text-secondary-100": userVote === "UPVOTE"})}
			>
			...
			<ProtectedButton
				...
				className={classname("text-primary border-2 border-primary rounded-lg", {"rounded-lg bg-primary text-secondary-100": userVote === "DOWNVOTE"})}
			>
				<svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 md:h-9 md:w-9" viewBox="0 0 20 20" fill="currentColor">
