	...
	return (
		...
		>
			...
			<ProtectedButton
				...
				className={classname("text-primary border border-primary rounded-lg", {"rounded-lg bg-primary text-secondary-100": userVote === "UPVOTE"})}
			>
				<svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 md:h-10 md:w-10" viewBox="0 0 20 20" fill="currentColor">
